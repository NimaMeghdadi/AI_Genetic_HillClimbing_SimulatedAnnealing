...
#            print (i)
        ...
        for i in range(timePeriod):
            ...
            if sumMW > requirement[i+1]:
                print(sumMW)
                print(requirement[i+1])
            print("\n")
...
def crosover(Pc):
    ...
    for i in parentList:
        # acceptable_chromosome(i.chromosome_detail)
        print(i.name)
        print(i.chromosome_detail)
...
def mutation(pm):
    ...
    while cont<len(parentList):
        ...
        if mut[0] == 1 :
            ...
            print ("old chromosome")
            print (chromosome_broke)
...
def broke_gen(chromosome ):
    ...
    print("unit : ")
    print( unit)
    print(chromosome[unit])
    while situ :
        per = random.randint(0,len(react_list[unit].permutations_list)-1)
        print("react")
        print(react_list[unit].permutations_list[per])
...
#        mutation(Pm)
        ...
        c+=1
    drow_chart(drowList,'generation algorithm \n fitness')
...
def simulated_annealing(temp):
    ...
    while s_temp > 0.00001:
        ...
        s_printFitnessList.append(s_CurrentState.fitness) 
    drow_chart(s_printFitnessList,"simulated_annealing \n Fitness")
...
def hill_climbing():
    ...
    drow_chart(h_printFitnessList,"HillClimbing /n fitness")
